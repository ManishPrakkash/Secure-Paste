...
export function Popup() {
  ...
  if (loading) {
    return (
      <div className="w-full h-[520px] bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 flex items-center justify-center relative overflow-hidden">
  ...
  return (
    <div className="w-full h-[520px] bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 relative overflow-hidden">
      ...
      <div className="relative h-full flex flex-col">
        ...
        {/* Main Content */}
        <div className="flex-1 px-4 space-y-3 pb-4 overflow-y-auto scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          ...
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-slate-600/50 to-slate-700/50 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-300" />
            <div className="relative rounded-2xl bg-gradient-to-br from-white/[0.08] to-white/[0.03] backdrop-blur-xl border border-white/10 p-4 shadow-xl">
              {/* Shine Effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700" />

              <div className="relative flex items-center justify-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center group-hover:from-accent-primary/20 group-hover:to-blue-600/20 transition-all duration-300">
                  <svg className="w-4 h-4 text-slate-400 group-hover:text-accent-primary transition-all duration-300 group-hover:rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-sm font-bold text-white group-hover:text-accent-primary transition-colors duration-300">
                  Settings & Preferences
                </span>
                <svg className="w-4 h-4 text-slate-500 group-hover:text-accent-primary group-hover:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
